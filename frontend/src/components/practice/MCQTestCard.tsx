    ...
    <div className="bg-slate-900/70 border border-white/10 hover:border-indigo-500/30 rounded-2xl p-5 flex flex-col justify-between gap-4 transition-all duration-200 shadow-lg backdrop-blur-md">
      <div className="space-y-3">
        ...
        <div className="flex items-start justify-between gap-2">
          ...
          {hasAttempted && (
            <span
              className={`text-lg font-black font-mono tabular-nums px-2.5 py-1 rounded-xl bg-slate-950 border border-white/10 ${
                passed ? "text-emerald-400 border-emerald-500/30" : "text-amber-400 border-amber-500/30"
              }`}
            >
        ...
        {hasAttempted && (
          <div>
            <div className="flex justify-between text-[10px] text-slate-400 mb-1">
              <span>Best Mastery Score</span>
              <span className="font-bold">{topic.last_score_pct}%</span>
            </div>
